...
import '../../../characters/cubits/current_character_id.dart';
import '../../../characters/editCharacter/widgets/notes_editable_tab.dart';
import '../../../characters/widgets/custom_dropdown_menu.dart';
import '../../../characters/widgets/prof_controller_row.dart';

@RoutePage()
class CharacterInGameScreen extends StatefulWidget {
  const CharacterInGameScreen({super.key});

  @override
  State<CharacterInGameScreen> createState() => _CharacterInGameScreenState();
}

class _CharacterInGameScreenState extends State<CharacterInGameScreen> {
  //photo
