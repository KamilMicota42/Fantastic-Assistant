...
import '../../../characters/viewCharacter/widgets/save_checks_container.dart';
import '../../../characters/widgets/description_left.dart';
import '../../../characters/widgets/title_left.dart';
import '../../../characters/widgets/value_and_description.dart';

@RoutePage()
class DmViewCharacterScreen extends StatefulWidget {
  const DmViewCharacterScreen({super.key});

  @override
  State<DmViewCharacterScreen> createState() => _DmViewCharacterScreenState();
}

class _DmViewCharacterScreenState extends State<DmViewCharacterScreen> {
  @override
