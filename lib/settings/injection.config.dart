...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i4.CharactersApi>(() => injectableModule.charactersApi);
    gh.lazySingleton<_i5.CurrentCharacterCubit>(
        () => injectableModule.currentCharacterCubit);
    gh.lazySingleton<_i6.CurrentCharacterId>(
        () => injectableModule.currentCharacterId);
    gh.lazySingleton<_i7.CurrentGameCubit>(
        () => injectableModule.currentGameCubit);
    gh.lazySingleton<_i8.CurrentGameId>(() => injectableModule.currentGameId);
    gh.lazySingleton<_i9.CurrentUserAdditionalData>(
        () => injectableModule.currentUserAdditionalData);
    gh.lazySingleton<_i10.FirebaseStorageApi>(
        () => injectableModule.firebaseStorageApi);
    gh.lazySingleton<_i11.GamesApi>(() => injectableModule.gamesApi);
    gh.lazySingleton<_i12.UserDataApi>(() => injectableModule.userDataApi);
    return this;
  }
}
